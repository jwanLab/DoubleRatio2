...
void runAnalysis()
{
    ...
    if(local) {
        ...
        chain->Add("/Users/mojie/alice/data/2018/LHC18q/000295588/pass3/AOD252/AOD/001/AliAOD.root");
        ...
        alienHandler->SetDataPattern("pass3/AOD252/*/AliAOD.root");
        ...
        alienHandler->SetGridOutputDir("DoubleRatioNUANUE");
